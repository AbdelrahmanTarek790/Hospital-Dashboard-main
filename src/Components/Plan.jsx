    ...
    return (
        <div className="grow bg-[#F8F9FA] ">
            ...
            <div className="bg-white m-2 lg:m-6 p-6 min-h-[720px]  rounded-lg">
                ...
                {userData.currentInstitutions.workingplan === null || userData.currentInstitutions.workingplan === "" ? (
                    <div>No link is set yet</div>
                ) : (
                    <iframe className="w-full h-[600px]" src={userData.currentInstitutions.workingplan}></iframe>
                )}
            </div>
                    ...
                    <div className="p-4 bg-white rounded min-w-[250px] lg:min-w-[450px]">
                        ...
                        <div className="flex justify-center mt-5">
                            <button
                                ...
                                className="flex items-center space-x-2 border-[2px] hover:bg-[#4f60ff] duration-300 border-[#4f60ff] p-3 group rounded-lg"
                            >
